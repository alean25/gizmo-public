...
#GALSF_SFR_IMF_VARIATION_TEMPERATURE_DEPENDENCE # determines the stellar IMF for each particle from the Steinhardt et al. 2020 theory. Cite Steinhardt et al. 2020, MNRAS, 491, 4940
